#!/bin/bash
date
json=$(curl --silent "https://api.github.com/repos/oven-sh/bun/releases/latest")
...
current_version=$(curl -H "Snap-Device-Series: 16" --silent "https://api.snapcraft.io/v2/snaps/info/bunjs")
